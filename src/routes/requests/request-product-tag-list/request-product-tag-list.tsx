    ...
    <Container data-testid="request-product-tag-list-container">
      ...
      <div className="flex size-full flex-col overflow-hidden" data-testid="request-product-tag-list-content">
            ...
            {requests?.map((request, index) => {
              ...
              return (
                <Table.Row key={request.id} data-testid={`request-product-tag-list-table-row-${index}`}>
                  ...
                  <Table.Cell data-testid={`request-product-tag-list-table-row-${index}-status`}>
                    {getRequestStatusBadge(request.status!)}
                  </Table.Cell>
                  <Table.Cell data-testid={`request-product-tag-list-table-row-${index}-actions`}>
                    <RequestMenu
        ...
        <Table.Pagination
          ...
          pageSize={PAGE_SIZE}
          data-testid="request-product-tag-list-pagination"
        />
      </div>
    </Container>
  );
