      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              ...
              data-testid="order-edit-create-totals"
            >
              <div
                className="mb-2 flex items-center justify-between"
                data-testid="order-edit-create-current-total"
              >
                <span
                  className="txt-small text-ui-fg-subtle"
                  data-testid="order-create-edit-form-current-total-label"
                >
                ...
                <span
                  className="txt-small text-ui-fg-subtle"
                  data-testid="order-create-edit-form-current-total-value"
                >
              ...
              <div
                className="mb-2 flex items-center justify-between"
                data-testid="order-edit-create-new-total"
              >
                <span
                  className="txt-small text-ui-fg-subtle"
                  data-testid="order-create-edit-form-new-total-label"
                >
                ...
                <span
                  className="txt-small text-ui-fg-subtle"
                  data-testid="order-create-edit-form-new-total-value"
                >
              ...
              <div
                ...
                data-testid="order-edit-create-refund-amount"
              >
                <span
                  className="txt-small font-medium"
                  data-testid="order-create-edit-form-refund-amount-label"
                >
                  {t('orders.exchanges.refundAmount')}
                </span>
                <span
                  className="txt-small font-medium"
                  data-testid="order-create-edit-form-refund-amount-value"
                >
                  ...
                  <Form.Item data-testid="order-edit-create-note-item">
                    <div className="mt-8 flex">
                      <div className="block flex-1">
                        <Form.Label data-testid="order-edit-create-note-label">
                          {t('fields.note')}
                        </Form.Label>
                        <Form.Hint
                          className="!mt-1"
                          data-testid="order-edit-create-note-hint"
                        >
                      ...
                      <div className="w-full flex-1 flex-grow">
                        <Form.Control data-testid="order-edit-create-note-control">
                          <Input
                            ...
                            data-testid="order-edit-create-note-input"
                          />
                        </Form.Control>
                      </div>
                    </div>
            ...
            <div
              ...
              data-testid="order-edit-create-notification"
            >
              <Form.Field
                control={form.control}
                  ...
                  return (
                    <Form.Item data-testid="order-edit-create-notification-item">
                      <div
                        ...
                        data-testid="order-create-edit-form-notification-control"
                      >
                        <Form.Control
                          className="mr-4 self-start"
                          data-testid="order-edit-create-notification-control"
                        >
                          <Switch
                            dir="ltr"
                        ...
                        <div className="block">
                          ...
                          <Form.Hint
                            className="!mt-1"
                            data-testid="order-edit-create-notification-hint"
                          >
        ...
        <RouteFocusModal.Footer data-testid="order-edit-create-footer">
          <div
            ...
            data-testid="order-create-edit-form-footer-actions"
          >
            <div className="flex items-center justify-end gap-x-2">
              <RouteFocusModal.Close asChild>
                <Button
                  ...
                  variant="secondary"
                  size="small"
                  data-testid="order-edit-create-cancel-button"
                >
