...
const contracts: RouteContract[] = [
  ...
  },
  {
    ...
    exportedComponent: "Component",
    requiredSourceFields: ["GateResult", "last_verified_at", "last_run_by", "GateStatus"],
    sample: {
  ...
  },
  {
    ...
    exportedComponent: "Component",
    requiredSourceFields: ["CaptureResponse", "DecisionType", "audit_log_id", "email_dispatched"],
  ...
  },
  {
    ...
    exportedComponent: "Component",
    requiredSourceFields: ["GenerateResponse", "audit_log_id", "SignResponse", "signed_at"],
  ...
  },
  {
    ...
    exportedComponent: "Component",
    requiredSourceFields: ["latency_ms", "entitlement_stats", "last_sync_at", "ServiceProbe"],
    sample: {
      updated_at: iso,
